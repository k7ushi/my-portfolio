    ...
    <section className="min-h-screen bg-white text-black font-sans px-4 sm:px-6 md:px-20 pb-20">
      <div className="flex flex-col md:flex-row items-center justify-between relative z-10 gap-10 mb-16">
        ...
        <div className="md:w-1/2 w-full text-center md:text-left">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-xl md:text-4xl leading-relaxed sm:leading-snug px-4 sm:px-0">
            ...
            />
            <br />I live <span className="line-through">at the computer</span>
            <br />
            in New Delhi, India
          </p>
        </div>
        ...
        <div className="relative md:w-1/2 w-full flex justify-center md:justify-end">
          <div className="relative">
            <img
              src={profileImg}
              alt="Khushi Anand"
              className="rounded-2xl w-[250px] sm:w-[300px] md:w-[400px]"
            />
            <img
              src={logoOverlay}
              alt="Logo Overlay"
              className="absolute top-8 -left-10 w-24 h-24 sm:w-20 sm:h-20"
            />
          </div>
        </div>
      </div>
        ...
        <div className="hidden sm:block absolute top-0 -left-10 mt-10 ml-4 sm:ml-10 z-10">
          ...
          <div className="mt-10 rounded-2xl p-4 sm:p-6 max-w-[90vw] sm:max-w-sm text-gray bg-[rgba(0,179,230,0.12)] backdrop-blur-lg">
            ...
            <p className="text-sm sm:text-base text-gray leading-relaxed">
              i once cried over a broken api call at 3am
              <br />
              and then fixed it like a queen 5 mins later.
              <br />
      ...
      <div className="text-right max-w-4xl ml-auto text-lg sm:text-xl md:text-2xl leading-relaxed space-y-6 px-4 sm:px-6">
        <p>
          ...
          <span className="bg-[#c2b5e2] rounded-md px-1">(MERN)</span>
          <br />
          with a{" "}
          <span className="bg-yellow-300 rounded-md px-1">
            background in English Literature
          </span>{" "}
          and a passion for building <br />
          beautiful, intuitive, and high-impact digital experiences.
        </p>

        <p>
          I didn’t come from tech,{" "}
          <span className="bg-[#e36a4e] rounded-md px-1">
            I built my own path into it.
          </span>{" "}
          Went from
          <br />
          <span className="bg-[#c2b5e2] rounded-md px-1">
            dissecting poetry to crafting code
          </span>{" "}
          that tells stories through interfaces. What
          <br />
          started as late-night{" "}
          <span className="bg-yellow-300 rounded-md px-1">
            curiosity turned into building full-stack applications
          </span>
          <br />
          using the MERN stack currently (MongoDB, Express.js, React.js,
          Node.js).
        </p>

        <p>
          <span className="bg-yellow-300 rounded-md px-1">Front-end</span> is my
          strong suit. I'm obsessed with clean UI, seamless UX,
          <br />
          <span className="bg-[#c2b5e2] rounded-md px-1">
            responsive layouts, and animations
          </span>{" "}
          that just feel right. I started by customizing
          <br />
          <span className="bg-[#e36a4e] rounded-md px-1">
            CMS templates with CSS and JavaScript
          </span>
          , that’s when I knew coding clicked.
        </p>
        ...
        <p>
          ...
          in{" "}
          <span className="bg-yellow-300 rounded-md px-1">
            Meta Ads, Email Marketing, and Google Analytics, SEO
          </span>
          , so I understand
          <br />
          the product and the performance side of tech. I believe good code is
          like
          <br />
        ...
        <p>
          ...
          <span className="bg-[#e36a4e] rounded-md px-1">
            MCA at Amity University (Delhi NCR)
          </span>
          ,
          <br />
      ...
      <div className="md:flex md:items-start md:justify-between gap-8">
        ...
        <div className="text-left px-4 sm:px-6 md:px-2 max-w-4xl text-base sm:text-lg md:text-xl leading-relaxed space-y-6">
          <p>
            I’ve been{" "}
            <span className="bg-[#c2b5e2] rounded-md px-1">
              building, learning, & delivering work
            </span>{" "}
            for years now,
            <br />
            from creating CMS websites to designing and developing everything
            <br />
            from scratch. Over the{" "}
            <span className="bg-yellow-300 rounded-md px-1">last 5 years</span>,
            I’ve grown into a developer
            <br />
            who owns every step of the process.
          </p>

          <p>
            From{" "}
            <span className="bg-[#e36a4e] rounded-md px-1">
              front-end finesse to back-end logic,
            </span>
            <br />I know what it takes to ship{" "}
            <span className="bg-[#c2b5e2] rounded-md px-1">
              solid, scalable, and meaningful work.
            </span>
          </p>

          <p>
            I’m nothing in my soul if not committed. I take full ownership
            <br />
            of my tasks, manage timelines, and communicate clearly throughout.
            <br />
            If there’s something I don’t know (been in the game long enough to
            <br />
            know it happens often in tech), I adapt fast.
            <br />
            <span className="bg-yellow-300 rounded-md px-1">
              I ask around, I search, I experiment, and{" "}
            </span>
            <br />
            <span className="bg-[#e36a4e] rounded-md px-1">
              I always deliver.
            ...
            <span className="bg-[#c2b5e2] rounded-md px-1">No delays.</span>{" "}
            <span className="bg-yellow-300 rounded-md px-1">Just results.</span>
          </p>

          <p>
            Every project I take on gets my full commitment. Whether solo or
            <br />
            in a team, I hold myself accountable and make sure the outcome isn’t
            <br />
            just what’s expected, but better. If you're looking for someone
            <br />
            <span className="bg-[#c2b5e2] rounded-md px-1">
              reliable, growth-driven,
            </span>{" "}
        ...
        <div className="mt-10 rounded-2xl p-6 max-w-sm text-gray bg-[rgba(0,179,230,0.12)] backdrop-blur-lg">
          ...
          <p className="text-base text-gray leading-relaxed">
            ...
            <br />
            ownership, commitment, and execution. i simply get the work done, no
            matter what.
            <br />
